...
# MAGIC %md
# MAGIC # Automated ML on Azure Databricks
# MAGIC 
...
# MAGIC %md
# MAGIC ## Configuring Your Local Environment
...
# MAGIC %md
# MAGIC ## Create a Folder to Host Sample Projects
...
# MAGIC ## Diagnostics
# MAGIC 
# MAGIC Opt-in diagnostics for better experience, quality, and security of future releases.
...
# MAGIC %md
# MAGIC Below is an example on how to register a private blob container
# MAGIC ```python
...
# MAGIC %md
# MAGIC The following will show the child runs and waits for the parent run to complete.

# COMMAND ----------

# MAGIC %md
# MAGIC #### Retrieve All Child Runs after the experiment is completed (in portal)
...
# MAGIC %md
# MAGIC ### Retrieve the Best Model after the above run is complete 
# MAGIC 
...
# MAGIC %md
# MAGIC #### Best Model Based on Any Other Metric after the above run is complete based on the child run
...
# MAGIC %md
# MAGIC #### View the engineered names for featurized data
...
# MAGIC %md
# MAGIC #### View the featurization summary
...
# MAGIC %md
# MAGIC When deploying an automated ML trained model, please specify _pippackages=['azureml-sdk[automl]']_ in your CondaDependencies.
# MAGIC 
...
# MAGIC %md
# MAGIC ![Impressions](https://PixelServer20190423114238.azurewebsites.net/api/impressions/MachineLearningNotebooks/how-to-use-azureml/azure-databricks/automl/automl-databricks-local-01.png)
